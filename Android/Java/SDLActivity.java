...
/**
    SDL Activity
*/
// Neslib: Do not derive from Activity
...
*/
    ...
    public static boolean mHasFocus; // Neslib: remove mIsResumedCalled
    ...
    // Neslib: no need for NativeState
    ...
    // public static boolean mBrokenLibraries = true; // Neslib: not needed

    // Main components
    protected static Activity mActivity; // Neslib: added this
    protected static SDLActivity mSingleton;
    // protected static SDLSurface mSurface; // Neslib: not used
    ...
    // protected static HIDDeviceManager mHIDDeviceManager; // Neslib: not used

    // This is what SDL runs in. It invokes SDL_main(), eventually
    // protected static Thread mSDLThread; // Neslib: not needed
    protected static boolean mSDLMainFinished = false;
    // protected static boolean mActivityCreated = false; // Neslib: not needed
    private static SDLFileDialogState mFileDialogState = null;
    // protected static boolean mDispatchingKeyEvent = false; // Neslib: not needed
    ...
    public static void initialize() {
        ...
        mActivity = null; // Neslib: added this
        mSingleton = null;
        // mSurface = null; // Neslib: not used
        mTextEdit = null;
        mLayout = null;
        mClipboardHandler = null;
        mCursors = new Hashtable<Integer, PointerIcon>();
        mLastCursorID = 0;
        // mSDLThread = null; // Neslib: not used
        // mIsResumedCalled = false; // Neslib: not used
        mHasFocus = true;
        // mNextNativeState = NativeState.INIT; // Neslib: not used
        // mCurrentNativeState = NativeState.INIT; // Neslib: not used
    }
    ...
    // Setup
    // Neslib: change onCreate to constructor
    //@Override
    //protected void onCreate(Bundle savedInstanceState) {
    public SDLActivity(Activity activity, String library) { 
        Log.v(TAG, "Manufacturer: " + Build.MANUFACTURER);
        Log.v(TAG, "Device: " + Build.DEVICE);
        Log.v(TAG, "Model: " + Build.MODEL);
        Log.v(TAG, "onCreate()");

        // Neslib: we don't need all this
       ...
       /* } catch(UnsatisfiedLinkError e) {
        ...
        System.loadLibrary(library); // Neslib: load our Delphi library
        ...
        mSingleton = this;
        mActivity = activity; // Neslib: added this
        SDL.setContext(activity); // Neslib: changed from "this" to "activity"

        mClipboardHandler = new SDLClipboardHandler();

        // mHIDDeviceManager = HIDDeviceManager.acquire(this); // Neslib: not used

        // Set up the surface
        // mSurface = createSDLSurface(this); // Neslib: not needed

        mLayout = new RelativeLayout(activity); // Neslib: changed from "this" to "activity"
        // mLayout.addView(mSurface); // Neslib: not needed
        ...
        // setContentView(mLayout); // Neslib: not needed

        setWindowStyle(false);

        // getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(this); // Neslib: not used

        // Get filename from "Open with" of another application
        Intent intent = activity.getIntent(); // Neslib: add "activity."
    ...
    public static int getNaturalOrientation() {
        ...
        Activity activity = mActivity; // Neslib: changed from (Activity)getContext();
        if (activity != null) {
    ...
    public void pressBackButton() {
        mActivity.runOnUiThread(new Runnable() { // Neslib: added .mActivity
            @Override
            public void run() {
                if (!SDLActivity.this.mActivity.isFinishing()) { // Neslib: added .mActivity
    ...
    public void superOnBackPressed() {
        mActivity.onBackPressed(); // Neslib: change "super" to "mActivity"
    }
    ...
    public static boolean dispatchingKeyEvent() {
        return false; // Neslib: always return false instead of mDispatchingKeyEvent;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            case COMMAND_TEXTEDIT_HIDE:
                if (mTextEdit != null) {
                    ...
                    // mSurface.requestFocus(); // Neslib: not needed
                }
                break;
    ...
    // C functions we call
    public static native String nativeGetVersion(); // Neslib: not used
    public static native int nativeSetupJNI();
    public static native void nativeInitMainThread();
    public static native void nativeCleanupMainThread();
    public static native int nativeRunMain(String library, String function, Object arguments);
    public static native void nativeLowMemory(); // Neslib: not used
    public static native void nativeSendQuit(); // Neslib: not used
    public static native void nativeQuit(); // Neslib: not used
    public static native void nativePause(); // Neslib: not used
    public static native void nativeResume(); // Neslib: not used
    public static native void nativeFocusChanged(boolean hasFocus); // Neslib: not used
    public static native void onNativeDropFile(String filename);
    public static native void nativeSetScreenResolution(int surfaceWidth, int surfaceHeight, int deviceWidth, int deviceHeight, float density, float rate); // Neslib: not used
    public static native void onNativeResize(); // Neslib: not used
    ...
    public static native void onNativeTouch(int touchDevId, int pointerFingerId,
                                            int action, float x,
                                            float y, float p); // Neslib: not used
    public static native void onNativePen(int penId, int button, int action, float x, float y, float p);
    public static native void onNativeAccel(float x, float y, float z); // Neslib: not used
    public static native void onNativeClipboardChanged();
    public static native void onNativeSurfaceCreated(); // Neslib: not used
    public static native void onNativeSurfaceChanged(); // Neslib: not used
    public static native void onNativeSurfaceDestroyed(); // Neslib: not used
    ...
    public static native void onNativeLocaleChanged(); // Neslib: not used
    public static native void onNativeDarkModeChanged(boolean enabled);
    public static native boolean nativeAllowRecreateActivity(); // Neslib: not used
    public static native int nativeCheckSDLThreadCounter(); // Neslib: not used
    public static native void onNativeFileDialog(int requestCode, String[] filelist, int filter); // Neslib: not used
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
        ...
        mActivity.setRequestedOrientation(req); // Neslib: changed to mActivity
    }
    ...
    public static void minimizeWindow() {
        ...
        mActivity.startActivity(startMain); // Neslib: changed to mActivity
    }
    ...
    public static boolean isAndroidTV() {
        UiModeManager uiModeManager = (UiModeManager) getContext().getSystemService("uimode"); // Neslib: changed from UI_MODE_SERVICE to "uimode"
...
//        }
    ...
    public int messageboxShowMessageBox(
        ...
        mActivity.runOnUiThread(new Runnable() { // Neslib: add mActivity
            @Override
            public void run() {
    ...
    protected void messageboxCreateAndShow(Bundle args) {
        ...
        final AlertDialog dialog = new AlertDialog.Builder(mActivity).create(); // Neslib: changed "this" to "mActivity"
        ...
        TextView message = new TextView(mActivity); // Neslib: changed "this" to "mActivity"
        ...
        LinearLayout buttons = new LinearLayout(mActivity); // Neslib: changed "this" to "mActivity"
        buttons.setOrientation(LinearLayout.HORIZONTAL);
        buttons.setGravity(Gravity.CENTER);
        for (int i = 0; i < buttonTexts.length; ++i) {
            Button button = new Button(mActivity); // Neslib: changed "this" to "mActivity"
        ...
        LinearLayout content = new LinearLayout(mActivity); // Neslib: changed "this" to "mActivity"
    ...
    private final Runnable rehideSystemUi = new Runnable() {
        ...
        public void run() {
            if (Build.VERSION.SDK_INT >= 19 /* Android 4.4 (KITKAT) */) {
                ...
                SDLActivity.this.mActivity.getWindow().getDecorView().setSystemUiVisibility(flags); // Neslib: added .mActivity
            }
        }
    };
    ...
    public void onSystemUiVisibilityChange(int visibility) {
        if (SDLActivity.mFullscreenModeActive && ((visibility & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0 || (visibility & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) == 0)) {
            ...
            Handler handler = mActivity.getWindow().getDecorView().getHandler(); // Neslib: added .mActivity
            if (handler != null) {
    ...
    public static boolean setCustomCursor(int cursorID) {
        ...
        if (Build.VERSION.SDK_INT >= 24 /* Android 7.0 (N) */) {
            try {
                // mSurface.setPointerIcon(mCursors.get(cursorID)); // Neslib: not used
            } catch (Exception e) {
                return false;
            }
        } else {
    ...
    public static boolean setSystemCursor(int cursorID) {
        ...
        if (Build.VERSION.SDK_INT >= 24 /* Android 7.0 (N) */) {
            try {
                // mSurface.setPointerIcon(PointerIcon.getSystemIcon(SDL.getContext(), cursor_type)); // Neslib: not used
            } catch (Exception e) {
                return false;
            }
        }
    ...
    public static boolean openURL(String url)
    {
        try {
            ...
            mActivity.startActivity(i); // Neslib: changed mSingleton to mActivity
        } catch (Exception ex) {
            return false;
        }
        return true;
        ...
        try
        {
            class OneShotTask implements Runnable {
                ...
                public void run() {
                    try
                    {
                        Toast toast = Toast.makeText(mActivity, mMessage, mDuration); // Neslib: changed mSingleton to mActivity
                        if (mGravity >= 0) {
            ...
            mActivity.runOnUiThread(new OneShotTask(message, duration, gravity, xOffset, yOffset)); // Neslib: changed mSingleton to mActivity
        } catch(Exception ex) {
            return false;
        }
        return true;
    ...
    public static int openFileDescriptor(String uri, String mode) throws Exception {
        if (mActivity == null) { // Neslib: changed mSingleton to mActivity
            return -1;
        }

        try {
            ParcelFileDescriptor pfd = mActivity.getContentResolver().openFileDescriptor(Uri.parse(uri), mode); // Neslib: changed mSingleton to mActivity
    ...
    public static boolean showFileDialog(String[] filters, boolean allowMultiple, boolean forWrite, int requestCode) {
        ...
        try {
            mActivity.startActivityForResult(intent, requestCode); // Neslib: changed mSingleton to mActivity
