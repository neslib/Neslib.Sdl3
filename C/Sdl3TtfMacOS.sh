...
rm libSdl3Ttf_macos_intel.a

clang -c -fPIC -O3 -arch x86_64 -isysroot $SDK_ROOT \
...
clang -c -fPIC -O3 -arch x86_64 -std=c++11 -isysroot $SDK_ROOT \
    -mmacosx-version-min=$MIN_VERSION \
    -Iinclude \
    -Iexternal/freetype/include \
    -Iexternal/harfbuzz/src \
...
ar rcs libSdl3Ttf_macos_intel.a *.o
ranlib libSdl3Ttf_macos_intel.a
rm *.o
